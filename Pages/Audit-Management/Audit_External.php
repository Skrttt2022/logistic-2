...
<path d="M19.6 22.3889C19.6 19.1243 17.0927 16.4778 14 16.4778C10.9072 16.4778 8.39999 19.1243 8.39999 22.3889V26.8222H19.6V22.3889Z" fill="currentColor">
     ...
     <path d="M22.4 26.8222V22.3889C22.4 20.8312 22.0195 19.3671 21.351 18.0949C21.6863 18.0039 22.0378 17.9556 22.4 17.9556C24.7197 17.9556 26.6 19.9404 26.6 22.3889V26.8222H22.4Z" fill="currentColor">
        ...
        <path d="M6.64896 18.0949C5.98058 19.3671 5.59999 20.8312 5.59999 22.3889V26.8222H1.39999V22.3889C1.39999 19.9404 3.2804 17.9556 5.59999 17.9556C5.96219 17.9556 6.31367 18.0039 6.64896 18.0949Z" fill="currentColor"></path>
                        ...
                        <div class="mx-5">
                          <h4 class="text-2xl font-semibold text-gray-700">External Audit</h4>
    ...
    <div>
            ...
            <select>
                <option value="Choose">Choose</option>
                          ...
                          <option value="01-2023">Jan</option>
        
                       <option value="02-2023">Feb</option>
        
                       <option value="02-2023">Mar</option>
        
                       <option value="02-2023">Apr</option>
        
                       <option value="02-2023">May</option>
        
                       <option value="02-2023">Jun</option>
        
                       <option value="02-2023">Jul</option>
        
                       <option value="02-2023">Aug</option>
        
                       <option value="02-2023">Sep</option>
        
                       <option value="02-2023">Oct</option>
        
                       <option value="02-2023">Nov</option>
        
                       <option value="02-2023">Dec</option>
                  ...
                  <th class="px-6 py-3 text-xs font-medium leading-4 tracking-wider text-left text-gray-500 uppercase border-b border-gray-200 bg-gray-50"> Date </th>
                   <th class="px-6 py-3 border-b border-gray-200 bg-gray-50">
                          ...
                          <tr>
                             ...
                             <div class="ml-4">
                         <div class="text-sm font-medium leading-5 text-gray-900">yeah</div>
                          </div>
                          
                           </td>
                            <td class="px-6 py-4 border-b border-gray-200 whitespace-nowrap">
                            <div class="text-sm leading-5 text-gray-900">22</div>
                        </td>
     <td class="px-6 py-4 border-b border-gray-200 whitespace-nowrap">
     <div class="text-sm leading-5 text-gray-900">11</div>
                    </td>
            <td class="px-6 py-4 text-sm leading-5 text-gray-500 border-b border-gray-200 whitespace-nowrap">02-2023</td>
                    ...
                    <a href="/logistic-2/excelwarehouse/" class="text-indigo-600 hover:text-indigo-900">Edit</a>
                          ...
                          <tr>
                             ...
                             <div class="ml-4">
                         <div class="text-sm font-medium leading-5 text-gray-900">kopiko</div>
                          </div>
                          
                           </td>
                            <td class="px-6 py-4 border-b border-gray-200 whitespace-nowrap">
                            <div class="text-sm leading-5 text-gray-900">25</div>
                        </td>
     <td class="px-6 py-4 border-b border-gray-200 whitespace-nowrap">
     <div class="text-sm leading-5 text-gray-900">13</div>
                    </td>
            <td class="px-6 py-4 text-sm leading-5 text-gray-500 border-b border-gray-200 whitespace-nowrap">02-2023</td>
                       <td class="px-6 py-4 text-sm font-medium leading-5 text-right border-b border-gray-200 whitespace-nowrap">
                    <a href="/logistic-2/excelwarehouse/" class="text-indigo-600 hover:text-indigo-900">Edit</a>
            ...
            <td class="px-6 py-4 text-sm leading-5 text-gray-500 border-b border-gray-200 whitespace-nowrap">02-2023</td>
                    ...
                    <a href="/logistic-2/excelwarehouse/" class="text-indigo-600 hover:text-indigo-900">Edit</a>
                          ...
                          <tr>
                             ...
                             <div class="ml-4">
                         <div class="text-sm font-medium leading-5 text-gray-900">shampoo</div>
                          </div>
     ...
     <td class="px-6 py-4 border-b border-gray-200 whitespace-nowrap">
     <div class="text-sm leading-5 text-gray-900">14</div>
                    </td>
            <td class="px-6 py-4 text-sm leading-5 text-gray-500 border-b border-gray-200 whitespace-nowrap">02-2023</td>
                       <td class="px-6 py-4 text-sm font-medium leading-5 text-right border-b border-gray-200 whitespace-nowrap">
                    <a href="/logistic-2/excelwarehouse/" class="text-indigo-600 hover:text-indigo-900">Edit</a>
                          ...
                          <tr>
                             ...
                             <div class="ml-4">
                         <div class="text-sm font-medium leading-5 text-gray-900">safeguard</div>
                          </div>
     ...
     <td class="px-6 py-4 border-b border-gray-200 whitespace-nowrap">
     <div class="text-sm leading-5 text-gray-900">10</div>
                    </td>
            <td class="px-6 py-4 text-sm leading-5 text-gray-500 border-b border-gray-200 whitespace-nowrap">02-2023</td>
                       <td class="px-6 py-4 text-sm font-medium leading-5 text-right border-b border-gray-200 whitespace-nowrap">
                    <a href="/logistic-2/excelwarehouse/" class="text-indigo-600 hover:text-indigo-900">Edit</a>
                          ...
                          <tr>
                             ...
                             <div class="ml-4">
                         <div class="text-sm font-medium leading-5 text-gray-900">milo</div>
                          </div>
     ...
     <td class="px-6 py-4 border-b border-gray-200 whitespace-nowrap">
     <div class="text-sm leading-5 text-gray-900">12</div>
                    </td>
            <td class="px-6 py-4 text-sm leading-5 text-gray-500 border-b border-gray-200 whitespace-nowrap">02-2023</td>
                       <td class="px-6 py-4 text-sm font-medium leading-5 text-right border-b border-gray-200 whitespace-nowrap">
                    <a href="/logistic-2/excelwarehouse/" class="text-indigo-600 hover:text-indigo-900">Edit</a>
