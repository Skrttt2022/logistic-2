...
<div class="antialiased sans-serif min-h-screen bg-white" style="min-height: 900px">
	...
	>
		<div class="flex justify-between">
			<h2 class="text-2xl font-bold mb-6 pb-2 tracking-wider uppercase">Supplier</h2>
			<div>
		...
		<div class="flex mb-8 justify-between">
			<div class="w-2/4">
				<div class="mb-2 md:mb-1 md:flex items-center">
					<label class="w-32 text-gray-800 block font-bold text-sm uppercase tracking-wide">Supplier No.</label>
					<span class="mr-4 inline-block hidden md:block">:</span>
					<div class="flex-1">
					<input class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-48 py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500" id="inline-full-name" type="text" placeholder="eg. #Supplier.    " x-model="invoiceNumber">
					</div>
				</div>
		...
		function invoices() {
			return {
				...
				generateInvoiceNumber(minimum, maximum) {
					...
					this.invoiceNumber = '#Supplier.-'+ randomNumber;
				},
