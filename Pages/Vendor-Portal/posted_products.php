                ...
                <div class="block h-full w-full mx-auto flex pt-6 md:pt-0 md:items-center bg-cover bg-right" style="background-image: url('https://images.unsplash.com/photo-1422190441165-ec2956dc9ecc?ixlib=rb-1.2.1&amp;ixid=eyJhcHBfaWQiOjEyMDd9&amp;auto=format&amp;fit=crop&amp;w=1600&amp;q=80');">
                    ...
                    <div class="container mx-auto">
                        <div class="flex flex-col w-full lg:w-1/2 md:ml-16 items-center md:items-start px-6 tracking-wide">
                            ...
                            <a class="text-xl inline-block no-underline border-b border-gray-600 leading-relaxed hover:text-black hover:border-black" href="#">Upload Product</a>
                            <label>
        ...
        <div class="container mx-auto flex items-center flex-wrap pt-4 pb-12">
            ...
            <div class="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
                <a href="#">
                    ...
                    <p class="pt-1 text-gray-900">Supplier 1</p>
                </a>
            </div>
            ...
            <div class="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
                <a href="#">
                    ...
                    <p class="pt-1 text-gray-900">Supplier 2</p>
                </a>
            </div>
            ...
            <div class="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
                <a href="#">
                    ...
                    <p class="pt-1 text-gray-900">Supplier 3</p>
                </a>
            </div>
            ...
            <div class="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
                <a href="#">
                    ...
                    <p class="pt-1 text-gray-900">Supplier 4</p>
                </a>
            </div>
            ...
            <div class="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
                <a href="#">
                    ...
                    <p class="pt-1 text-gray-900">Supplier 5</p>
                </a>
            </div>
            ...
            <div class="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
                <a href="#">
                    ...
                    <p class="pt-1 text-gray-900">Supplier 6</p>
                </a>
            </div>
            ...
            <div class="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
                <a href="#">
                    ...
                    <p class="pt-1 text-gray-900">Supplier 7</p>
                </a>
            </div>
            ...
            <div class="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
                <a href="#">
                    ...
                    <p class="pt-1 text-gray-900">Supplier 8</p>
                </a>
            </div>
