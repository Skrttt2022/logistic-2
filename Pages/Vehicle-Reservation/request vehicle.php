        ...
        <div class="mt-4">
            <div class="flex flex-wrap -mx-6">
                <div class="w-full px-6 sm:w-1/2 xl:w-1/3">
                    ...
                    <div class="mx-5">
                        <a clas href="/Logistic-2/Pages/Vehicle-Reservation/Dashboard.php">
...
<div class="rounded-2xl flex-col dark:bg-slate-900/70 bg-white flex" form="">
    ...
    <div class="relative">
        <input  placeholder="Requestor Name..."type="text" class="px-3 py-2 max-w-full focus:ring focus:outline-none border-gray-700 rounded w-full dark:placeholder-gray-400 h-12 border bg-white dark:bg-slate-800 pl-10">
    ...
    <div class="relative">
        <input placeholder="Last Name..." type="email" class="px-3 py-2 max-w-full focus:ring focus:outline-none border-gray-700 rounded w-full dark:placeholder-gray-400 h-12 border bg-white dark:bg-slate-800 pl-10">
        <span class="inline-flex justify-center items-center w-10 h-12 absolute top-0 left-0 z-10 pointer-events-none text-gray-500 dark:text-slate-400">
...
<div class="mb-6 last:mb-0">
    <label class="block font-bold mb-2">Driver Name</label>
    <div class="">
        <div class="relative">
            <input placeholder="Driver..." type="tel" class="px-3 py-2 max-w-full focus:ring focus:outline-none border-gray-700 rounded w-full dark:placeholder-gray-400 h-12 border bg-white dark:bg-slate-800">
            <!---->
        </div>
    </div>
...
<div class="mb-6 last:mb-0">
    <label class="block font-bold mb-2">Types of Vehicle</label>
    <div class="">
        <div class="relative">
            <select class="px-3 py-2 max-w-full focus:ring focus:outline-none border-gray-700 rounded w-full dark:placeholder-gray-400 h-12 border bg-white dark:bg-slate-800">
                <option value="[object Object]">Vios Red</option>
                <option value="[object Object]">Vios Green</option>
            <option value="[object Object]">Raptop</option>
            <option value="[object Object]">Innova</option>
            <option value="[object Object]">Innova Red</option>
            <option value="[object Object]">Fortuner</option>
            <option value="[object Object]">L300</option>
            <option value="[object Object]">Fortuner Black</option>
        </select>
        <!---->
    </div>
</div>
...
<div class="mb-6 last:mb-0">
    <label class="block font-bold mb-2">Purposes</label>
    <div class="">
        <div class="relative">
            <textarea class="px-3 py-2 max-w-full focus:ring focus:outline-none border-gray-700 rounded w-full dark:placeholder-gray-400 h-24 border bg-white dark:bg-slate-800" placeholder="Explain how we can help you">
